...
static PinvokeImport QCall_imports [] = {
...
static void *pinvoke_tables[] = { libSystem_Native_imports,libSystem_IO_Compression_Native_imports,QCall_imports,};
static char *pinvoke_names[] = { "libSystem.Native","libSystem.IO.Compression.Native","QCall",};
